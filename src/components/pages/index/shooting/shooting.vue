<template>
    <section class="page-shooting">
        <div class="shooting shooting-large" v-show="type !== 'small'">
            <div class="img-group">
        ...
        <div class="shooting shooting-small" v-show="type === 'small'">
            <div class="img-group">
                <div class="img-item small-col"
                     data-type="shooting"
...
<script>
    ...
    export default {
        ...
        mounted() {
            $('.shooting .img-wrap').each(function (index, item) {
